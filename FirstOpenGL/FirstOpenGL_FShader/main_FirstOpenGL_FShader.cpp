...
R"(
	...
	void main()
	{
		mat4 R; // Z-축 중심으로 10도 회전
		R[0][0] = cos(radians(45.f)); R[1][0] = -sin(radians(45.f)); R[2][0] = 0.f; R[3][0] = 0.f;
		R[0][1] = sin(radians(45.f)); R[1][1] = cos(radians(45.f));  R[2][1] = 0.f; R[3][1] = 0.f;
		R[0][2] = 0.f;                R[1][2] = 0.f;                 R[2][2] = 1.f; R[3][2] = 0.f;
